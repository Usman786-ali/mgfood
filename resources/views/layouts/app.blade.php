                ...
                <div class="footer-grid">
                    ...
                    <div class="footer-col brand-col">
                        ...
                        <div class="footer-social">
                            <a href="https://www.facebook.com/mgfoodeventplanner" target="_blank" class="social-icon">
                            ...
                            <a href="https://www.instagram.com/mgfoodeventplanner" target="_blank" class="social-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white"
                                    viewBox="0 0 24 24">
                                    <path
                            ...
                            <a href="https://www.youtube.com/@mgfoodeventplanner" target="_blank" class="social-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white"
                                    viewBox="0 0 24 24">
                                    <path
                            ...
                            <a href="https://www.tiktok.com/@mgfoodeventplanner" target="_blank" class="social-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white"
                                    viewBox="0 0 24 24">
                                    <path
                    ...
                    <div class="footer-col contact-col">
                        ...
                        <ul class="contact-list">
                            ...
                            <li>
                                ...
                                <span><strong>Our Kitchen:</strong> Plot L-5, Street No. 1, Altaf Town, Korangi Creek,
